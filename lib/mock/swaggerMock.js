...
var swaggerMock = function (app, _a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.urls, urls = _c === void 0 ? [] : _c, propertyResolver = _b.propertyResolver, resultResolver = _b.resultResolver, _d = _b.basePath, mockBasePath = _d === void 0 ? '' : _d, _e = _b.enableWatcher, enableWatcher = _e === void 0 ? true : _e, _f = _b.fetchOptions, fetchOptions = _f === void 0 ? {} : _f;
    ...
    function loadRouters(curUrls, showMessage) {
        curUrls.forEach(function (url, index) {
            var currentFetchOptions = fetchOptions;
            var targetUrl = urls[index];
            if (Array.isArray(targetUrl)) {
                currentFetchOptions = targetUrl[2];
            }
            utils_1.fetchSwaggerJson(url, currentFetchOptions)
