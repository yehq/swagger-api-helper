...
exports.default = (function (items, key, basePath, filename, _a) {
    ...
    } : _b, _c = _a.importRequest, importRequest = _c === void 0 ? function () { return "import request from '@/utils/request';"; } : _c, _d = _a.importStringify, importStringify = _d === void 0 ? function () { return "import stringify from '@/utils/stringify';"; } : _d, _e = _a.hasExtraFetchOptions, hasExtraFetchOptions = _e === void 0 ? true : _e, hasBasePath = _a.hasBasePath;
    var currentBasePath = hasBasePath ? basePath : '';
    var imports = [
        importRequest(filename),
        hasExtraFetchOptions && importExtraFetchOptions(filename),
    ].filter(Boolean);
    var _f = renderContent(items, currentBasePath), content = _f.content, globalInterfaceNames = _f.globalInterfaceNames, hasQuery = _f.hasQuery;
    ...
    function renderMethodInterface(item, interfaceNames) {
        ...
        var queryInterface = renderInterface(parametersInQuery, interfaceNames.query);
        if (queryInterface) {
            payloadContent.push({
                name: "query" /* query */,
     ...
     * @param {string} name
     */
    function renderInterface(parameters, name) {
        ...
        var result = getInterface_1.default(schema, 1);
