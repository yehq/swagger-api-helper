...
exports.default = (function (items, key, basePath, filename, _a) {
    ...
    function renderMethodInterface(item, interfaceNames) {
        ...
        if (parametersInFormData.length > 0) {
            payloadContent.push({
                name: "body" /* body */,
                typeName: 'FormData',
                description: "" + renderInterface(parametersInFormData, 'FormContent', interfaces_1.CommentType.single),
            });
        }
    ...
    function renderInterface(parameters, name, commentType) {
        if (commentType === void 0) { commentType = interfaces_1.CommentType.multiline; }
